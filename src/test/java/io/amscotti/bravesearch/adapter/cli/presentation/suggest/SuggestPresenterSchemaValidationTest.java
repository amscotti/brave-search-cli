...
/**
 * Every machine document and line the suggest presenter emits satisfies the published v1
 ...
 * pinned suggest payloads.
 */
final class SuggestPresenterSchemaValidationTest {
    ...
    void zeroResultDocumentsSatisfyTheirSchemas() {
        SuggestSearchResult empty = new SuggestSearchResult(
    ...
    private static Outcome.Failure<SuggestSearchResult> authenticationFailure() {
    ...
    private static Outcome.Failure<SuggestSearchResult> transportFailure() {
    ...
    private static byte[] fixture(String name) {
        ...
        try (InputStream bytes = SuggestPresenterSchemaValidationTest.class.getResourceAsStream(resource)) {
            if (bytes == null) {
