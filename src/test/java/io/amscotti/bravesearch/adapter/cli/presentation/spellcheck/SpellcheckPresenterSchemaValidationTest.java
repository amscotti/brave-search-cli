...
/**
 * Every machine document and line the spellcheck presenter emits satisfies the published v1
 ...
 * pinned spellcheck payloads.
 */
final class SpellcheckPresenterSchemaValidationTest {
    ...
    void zeroResultDocumentsSatisfyTheirSchemas() {
        SpellcheckSearchResult empty = new SpellcheckSearchResult(
    ...
    private static Outcome.Failure<SpellcheckSearchResult> authenticationFailure() {
    ...
    private static Outcome.Failure<SpellcheckSearchResult> transportFailure() {
    ...
    private static byte[] fixture(String name) {
        ...
        try (InputStream bytes = SpellcheckPresenterSchemaValidationTest.class.getResourceAsStream(resource)) {
            if (bytes == null) {
