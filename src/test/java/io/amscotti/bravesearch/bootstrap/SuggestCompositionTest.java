 ...
 */
final class SuggestCompositionTest {
    ...
    void aLoopbackRunResolvesItsCredentialExactlyOnce() {
        ...
        SuggestComposition process = SuggestComposition.process(storedCredentials(), environment);

        RunResult result = runMain(exchanges, environment, process, "suggest", "--base-url", "http://127.0.0.1:1", "q");
    ...
    private RunResult runMain(
            ExchangeRegistry exchanges, Function<String, String> environment, SuggestComposition suggestSearch, String... args) {
