 ...
 */
final class SpellcheckCompositionTest {
    ...
    void aLoopbackRunResolvesItsCredentialExactlyOnce() {
        ...
        SpellcheckComposition process = SpellcheckComposition.process(storedCredentials(), environment);

        RunResult result = runMain(exchanges, environment, process, "spellcheck", "--base-url", "http://127.0.0.1:1", "q");
    ...
    private RunResult runMain(
            ExchangeRegistry exchanges, Function<String, String> environment, SpellcheckComposition spellcheckSearch, String... args) {
