 ...
 */
final class PlacesEnrichmentCompositionTest {
    ...
    void aLoopbackRunResolvesItsCredentialExactlyOnce() {
        ...
        PlacesEnrichmentComposition process = PlacesEnrichmentComposition.process(storedCredentials(), environment);

        RunResult result = runMain(exchanges, environment, process, "places", "details", "--base-url", "http://127.0.0.1:1", "a1b2c3d4");
    ...
    private RunResult runMain(
            ExchangeRegistry exchanges, Function<String, String> environment, PlacesEnrichmentComposition placesEnrichment, String... args) {
        ...
        try {
            int exitCode = new Main(
                            ...
                            VideoSearchComposition.process(storedCredentials(), environment),
