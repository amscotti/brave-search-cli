 ...
 */
final class ImageSearchCompositionTest {
    ...
    void aLoopbackRunResolvesItsCredentialExactlyOnce() {
        ...
        ImageSearchComposition process = ImageSearchComposition.process(storedCredentials(), environment);

        RunResult result = runMain(exchanges, environment, process, "images", "--base-url", "http://127.0.0.1:1", "q");
    ...
    private RunResult runMain(
            ExchangeRegistry exchanges, Function<String, String> environment, ImageSearchComposition imagesSearch, String... args) {
