 ...
 */
final class RichCompositionTest {
    ...
    void aLoopbackRunResolvesItsCredentialExactlyOnce() {
        ...
        RichComposition process = RichComposition.process(storedCredentials(), environment);

        RunResult result = runMain(exchanges, environment, process, "rich", "--base-url", "http://127.0.0.1:1", "cb8f5a1e2d3c4b5a");
    ...
    private RunResult runMain(
            ExchangeRegistry exchanges, Function<String, String> environment, RichComposition richCallbacks, String... args) {
