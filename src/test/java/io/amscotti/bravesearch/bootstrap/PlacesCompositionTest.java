 ...
 */
final class PlacesCompositionTest {
    ...
    void aLoopbackRunResolvesItsCredentialExactlyOnce() {
        ...
        PlacesComposition process = PlacesComposition.process(storedCredentials(), environment);

        RunResult result = runMain(exchanges, environment, process, "places", "search", "--base-url", "http://127.0.0.1:1", "coffee");
    ...
    private RunResult runMain(
            ExchangeRegistry exchanges, Function<String, String> environment, PlacesComposition placesSearch, String... args) {
