...
/**
 * One completed blocking Answers exchange on the public surface: the typed exchange metadata — the
...
public final class AnswersResponse {
    ...
    public boolean equals(Object other) {
        return other instanceof AnswersResponse that
    ...
    public String toString() {
        return "AnswersResponse[httpStatus="
