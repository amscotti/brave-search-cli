...
/**
 * One completed LLM-context exchange on the public surface: the typed exchange metadata — the
...
public final class ContextResponse {
    ...
    public boolean equals(Object other) {
        return other instanceof ContextResponse that
    ...
    public String toString() {
        return "ContextResponse[httpStatus="
