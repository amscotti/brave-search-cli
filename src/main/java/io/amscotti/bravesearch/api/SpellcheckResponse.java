...
/**
 * One completed spellcheck exchange on the public surface: the typed exchange metadata — the
 ...
 */
public final class SpellcheckResponse {
    ...
    public boolean equals(Object other) {
        return other instanceof SpellcheckResponse that
    ...
    public String toString() {
        return "SpellcheckResponse[httpStatus="
