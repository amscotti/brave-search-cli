...
/**
 * One completed suggest exchange on the public surface: the typed exchange metadata — the
...
public final class SuggestResponse {
    ...
    public boolean equals(Object other) {
        return other instanceof SuggestResponse that
    ...
    public String toString() {
        return "SuggestResponse[httpStatus="
