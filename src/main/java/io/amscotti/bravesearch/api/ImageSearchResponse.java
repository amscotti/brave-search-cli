...
/**
 * One completed image-search exchange on the public surface: the typed exchange metadata — the
...
public final class ImageSearchResponse {
    ...
    public boolean equals(Object other) {
        return other instanceof ImageSearchResponse that
    ...
    public String toString() {
        return "ImageSearchResponse[httpStatus="
