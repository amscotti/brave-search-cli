...
/**
 * One completed place-search exchange on the public surface: the typed exchange metadata — the
...
public final class PlaceSearchResponse {
    ...
    public boolean equals(Object other) {
        return other instanceof PlaceSearchResponse that
    ...
    public String toString() {
        return "PlaceSearchResponse[httpStatus="
