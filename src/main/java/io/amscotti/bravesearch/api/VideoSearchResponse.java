...
/**
 * One completed video-search exchange on the public surface: the typed exchange metadata — the
...
public final class VideoSearchResponse {
    ...
    public boolean equals(Object other) {
        return other instanceof VideoSearchResponse that
    ...
    public String toString() {
        return "VideoSearchResponse[httpStatus="
