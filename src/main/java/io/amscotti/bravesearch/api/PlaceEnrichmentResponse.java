...
/**
 * One completed place-enrichment exchange on the public surface: the typed exchange metadata — the
 ...
 */
public final class PlaceEnrichmentResponse {
    ...
    public PlaceEnrichmentResponse(
            int httpStatus,
    ...
    public boolean equals(Object other) {
        return other instanceof PlaceEnrichmentResponse that
    ...
    public String toString() {
        return "PlaceEnrichmentResponse[httpStatus="
