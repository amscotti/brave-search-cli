...
/**
 * One completed web-search exchange on the public surface: the typed exchange metadata — the
...
public final class WebSearchResponse {
    ...
    public boolean equals(Object other) {
        return other instanceof WebSearchResponse that
    ...
    public String toString() {
        return "WebSearchResponse[httpStatus="
