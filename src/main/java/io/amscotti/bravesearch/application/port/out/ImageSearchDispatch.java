...
/**
 * One parsed images-search invocation in the shape the exchange needs: the validated
 ...
 * instead of re-resolving from the environment.
 *
 ...
 */
public record ImageSearchDispatch(
