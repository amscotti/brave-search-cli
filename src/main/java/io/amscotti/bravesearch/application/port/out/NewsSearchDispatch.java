...
/**
 * One parsed news-search invocation in the shape the exchange needs: the validated request,
 * the origin the parsed {@code --base-url} selected, the already-resolved credential the
 * preflight drew for that origin, the two parsed budgets, and the parsed {@code Api-Version}
 ...
 */
public record NewsSearchDispatch(
