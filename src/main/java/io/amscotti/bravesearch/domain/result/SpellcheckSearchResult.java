...
/**
 * One completed spellcheck exchange as the application sees it: the HTTP status, the
 * lossless bounded body bytes, and the metadata observed on the response headers.
 *
 * <p>The body stays raw on purpose — the structured projection of corrections is a
 ...
 */
public record SpellcheckSearchResult(
        int httpStatus,
